...
exports.HospitalUploadService = void 0;
const path = __importStar(require("path"));
const dataConverter_1 = require("../dataConverter");
const RegrasHospitais_1 = require("../../controllers/RegrasHospitais");
class HospitalUploadService {
    constructor() {
        this.allowedFormats = ['.xlsx', '.xml', '.json', '.hl7', '.fhir', '.csv'];
        this.dataConverter = new dataConverter_1.DataConverter();
        this.regrasHospitais = new RegrasHospitais_1.RegrasHospitais();
    }
    async upload(data) {
...
exports.HospitalUploadService = HospitalUploadService;
//# sourceMappingURL=hospitalUploadService.js.map