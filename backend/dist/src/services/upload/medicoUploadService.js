...
exports.MedicoUploadService = void 0;
const path = __importStar(require("path"));
const dataConverter_1 = require("../dataConverter");
const RegrasMedicos_1 = require("../../controllers/RegrasMedicos");
class MedicoUploadService {
    constructor() {
        this.allowedFormats = ['.xlsx', '.xml', '.json', '.hl7', '.fhir', '.csv'];
        this.dataConverter = new dataConverter_1.DataConverter();
        this.regrasMedicos = new RegrasMedicos_1.RegrasMedicos();
    }
    async upload(data) {
...
exports.MedicoUploadService = MedicoUploadService;
//# sourceMappingURL=medicoUploadService.js.map