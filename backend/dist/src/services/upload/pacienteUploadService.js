...
exports.PatientUploadService = void 0;
const path = __importStar(require("path"));
const dataConverter_1 = require("../dataConverter");
const RegrasPacientes_1 = require("../../controllers/RegrasPacientes");
class PatientUploadService {
    constructor() {
        ...
        this.regrasPacientes = new RegrasPacientes_1.RegrasPacientes();
    }
    async upload(data) {
...
//# sourceMappingURL=pacienteUploadService.js.map