...
class Medico4json {
     ...
     */
    async processaMedico4Json(data) {
        // Validate input data
        ...
        const fileName = `medico-data-${timestamp}.json`;
        ...
        try {
            ...
            console.log(`Medico data written to: ${filePath}`);
...
exports.Medico4json = Medico4json;
//# sourceMappingURL=medico4json.js.map